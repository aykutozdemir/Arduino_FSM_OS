...
namespace Utilities
{
    ...
    /**
     * @brief Securely cleans sensitive data from memory
     *
     * Overwrites the memory area with zeros to prevent sensitive data
     * from being recoverable after use.
     *
     * @param data Pointer to the data to clean
     * @param size Size of the data in bytes
     */
    void secureClean(void *data, size_t size);
