...
Command subCommands[]{
    COMMAND(cmd_calc_add, "+", ARG(ArgType::Int), ARG(ArgType::Int), nullptr, "add numbers"),
    COMMAND(cmd_calc_mul, "*", ARG(ArgType::Int), ARG(ArgType::Int), nullptr, "multiply numbers"),
};

Command commands[]{
    COMMAND(cmd_help, "help", nullptr, "list commands"),
    COMMAND(cmd_calc, "calc", ARG(ArgType::Int), ARG(ArgType::Int), subCommands, "calculator"),
};
